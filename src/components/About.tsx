...
export const About = () => {
  ...
  useEffect(() => {
    document.body.style.overflow = showFlipbook ? 'hidden' : 'auto';
    return () => {
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 md:gap-16 items-center">
          ...
          <div className="relative animate-scale-in order-1 lg:order-2 mb-8 lg:mb-0">
            {showVideo ? (
              <div className="relative rounded-xl md:rounded-2xl overflow-hidden aspect-video">
                <iframe
                  className="w-full h-full"
                  src="https://www.youtube.com/embed/CMtNbja14ao?autoplay=1"
                  title="Almanbar Company Introduction"
                  frameBorder="0"
              ...
              <div
                ...
                className="relative bg-gradient-to-br from-almanbar-navy to-almanbar-navy-light rounded-xl md:rounded-2xl aspect-video overflow-hidden group cursor-pointer"
              >
